...
pub const HELP_EXPLANATION: &'static str = "I will create a support thread with your supplied title.";
...
pub enum SupportThreadError {
    #[error("This server has not been configured with /support_channel. \
